# Install script for directory: /home/flo/Documents/test/trying/build
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/bin/trying" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/bin/trying"
         RPATH "")
  endif()
...
file(INSTALL DESTINATION "/usr/bin" TYPE EXECUTABLE FILES "/home/flo/Documents/test/trying/out/trying")
  if(EXISTS "$ENV{DESTDIR}/usr/bin/trying" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/bin/trying")
    endif()
  endif()
endif()
